...
MH.mechanismClass = mech;
AH.mechanismClass = mech;

MH.permissibleCrushingStress = permissibleCrushingStress;
AH.permissibleCrushingStress = permissibleCrushingStress;

MH.materialE250Stress =
    ["M1", "M2", "M3", "M4", "M5", "M6"].includes(mech)
        ? 1250
        : 1100;

AH.materialE250Stress =
    ["M1", "M2", "M3", "M4", "M5", "M6"].includes(mech)
        ? 1250
        : 1100;

MH.materialE350Stress =
    ["M1", "M2", "M3", "M4", "M5", "M6"].includes(mech)
        ? 1500
        : 1350;
        
AH.materialE350Stress =
    ["M1", "M2", "M3", "M4", "M5", "M6"].includes(mech)
        ? 1500
        : 1350;
}
...
CRANE.ROPE_DRUM_STRESS.mechanismClass = mech;

CRANE.ROPE_DRUM_STRESS.e250Stress = e250Stress;
CRANE.ROPE_DRUM_STRESS.e350Stress = e350Stress;

CRANE.ROPE_DRUM_STRESS.permissibleCrushingStress =
    e250Stress;
...
function calcBarrelCoupling() {
    ...
    MH1.F =
        MH1.Wnet /
        (MH1.ir * MH1.K2 * MH1.Mrd);

    AH1.F =
        AH1.Wnet /
        (AH1.ir * AH1.K2 * AH1.Mrd);

    // Coupling torque
    MH1.T =
        (975 * 9.81 * MH1.Ps * MH1.K1) /
        (MH1.n * MH1.Mrd);

    AH1.T =
        (975 * 9.81 * AH1.Ps * AH1.K1) /
        (AH1.n * AH1.Mrd);

    // Torque due to radial load
    MH1.Tc =
        MH1.F * MH1.d * MH1.K1 / 2;

    AH1.Tc =
        AH1.F * AH1.d * AH1.K1 / 2;

    // Static radial force
    MH1.Fp =
        MH1.Wnet /
        (MH1.Mrd * MH1.ir * MH1.K2);

    AH1.Fp =
        AH1.Wnet /
        (AH1.Mrd * AH1.ir * AH1.K2);
    ...
    document.getElementById("bc_mnet_mh").innerHTML =
        MH1.Mnet.toFixed(2);

    document.getElementById("bc_mnet_ah").innerHTML =
        AH1.Mnet.toFixed(2);

    document.getElementById("bc_wnet_mh").innerHTML =
        MH1.Wnet.toFixed(2);

    document.getElementById("bc_wnet_ah").innerHTML =
        AH1.Wnet.toFixed(2);

    document.getElementById("bc_Wd_mh").innerHTML =
        MH1.Wd.toFixed(2);

    document.getElementById("bc_Wd_ah").innerHTML =
        AH1.Wd.toFixed(2);

    document.getElementById("bc_speed_mh").innerHTML =
        MH1.n.toFixed(3);

    document.getElementById("bc_speed_ah").innerHTML =
        AH1.n.toFixed(3);

    document.getElementById("bc_torque_mhc").innerHTML =
        MH1.Tc.toFixed(2);

    // IMPORTANT: AH1.Tc
    document.getElementById("bc_torque_ahc").innerHTML =
        AH1.Tc.toFixed(2);

    document.getElementById("bc_torque_mh").innerHTML =
        MH1.T.toFixed(2);

    document.getElementById("bc_torque_ah").innerHTML =
        AH1.T.toFixed(2);

    document.getElementById("bc_static_mh").innerHTML =
        MH1.Fp.toFixed(2);

    document.getElementById("bc_static_ah").innerHTML =
        AH1.Fp.toFixed(2);

    document.getElementById("bc_radial_mh").innerHTML =
        MH1.Fr.toFixed(2);

    document.getElementById("bc_radial_ah").innerHTML =
        AH1.Fr.toFixed(2);


    // ================= BARREL COUPLING SELECTION =================

    let selMH =
        selectBarrelCoupling(MH1.T, MH1.Fr);

    let selAH =
        selectBarrelCoupling(AH1.T, AH1.Fr);
    ...
    MH1.recommendation = selMH;
    AH1.recommendation = selAH;
}
// =====================================================
...
function calcLTLoad() {
    ...
    // Weight of bridge without crane girder contribution
    LT.Wb =
        LT.Wc - LT.G;


    // Wheel load due to bridge weight
    LT.w1 =
        LT.Wb / LT.n;


    // Wheel load due to lifted load
    LT.w2 =
        (LT.G + LT.Q) *
        (LT.S - LT.A) /
        ((LT.n / 2) * LT.S);
    ...
    // Wheel load due to hook approach
    LT.w3 =
        (LT.G * LT.B) /
        ((LT.n / 2) * LT.S);
...
function calcWheelSelection() {
    ...
    CT.P1 = +document.getElementById("ct_pl").value || 0;
    LT.P1 = +document.getElementById("lt_pl").value || 0;

    CT.P4 = +document.getElementById("ct_b").value || 0;
    LT.P4 = +document.getElementById("lt_b").value || 0;

    CT.P5 = +document.getElementById("ct_r").value || 0;
    LT.P5 = +document.getElementById("lt_r").value || 0;

    CT.P6 = +document.getElementById("ct_c1").value || 0;
    LT.P6 = +document.getElementById("lt_c1").value || 0;

    CT.P7 = +document.getElementById("ct_c2").value || 0;
    LT.P7 = +document.getElementById("lt_c2").value || 0;
    ...
    // Calculated Wheel Diameter
    CT.D1 =
        (1000 * CT.B1) /
        (CT.P1 * CT.C1 * CT.P6 * CT.P7);

    LT.D1 =
        (1000 * LT.B1) /
        (LT.P1 * LT.C1 * LT.P6 * LT.P7);
    ...
    document.getElementById("ct_pmean").innerHTML =
        CT.A1.toFixed(2);

    document.getElementById("lt_pmean").innerHTML =
        LT.A1.toFixed(2);


    document.getElementById("ct_f1").innerHTML =
        CT.B1.toFixed(2);

    document.getElementById("lt_f1").innerHTML =
        LT.B1.toFixed(2);


    document.getElementById("ct_w").innerHTML =
        CT.C1.toFixed(2);

    document.getElementById("lt_w").innerHTML =
        LT.C1.toFixed(2);


    document.getElementById("ct_d_calc").innerHTML =
        CT.D1.toFixed(2);

    document.getElementById("lt_d_calc").innerHTML =
        LT.D1.toFixed(2);
    ...
    let ct_manu_dia =
        +document.getElementById("ct_d_manu").value || 0;

    let lt_manu_dia =
        +document.getElementById("lt_d_manu").value || 0;


    // Store manufacturer values
    CT.manufacturerDia = ct_manu_dia;
    LT.manufacturerDia = lt_manu_dia;
    ...
    CT.railSize =
        document.getElementById("ct_rail_size").value;

    LT.railSize =
        document.getElementById("lt_rail_size").value;
    ...
    CT.recommendation = ctWheel;
    LT.recommendation = ltWheel;
...
function calcGearbox() {
    ...
    CT1.D =
        +CRANE.WHEEL_SELECTION.CT.finalDia / 1000;

    LT1.D =
        +CRANE.WHEEL_SELECTION.LT.finalDia / 1000;


    // Number of Falls — Hoist only
    MH1.F = +CRANE.ROPE.MH.F;
    AH1.F = +CRANE.ROPE.AH.F;


    // Number of Rope Drum — Hoist only
    ...
    // Duty Factor
    MH1.DF =
        +document.getElementById("df_mh").value || 0;

    AH1.DF =
        +document.getElementById("df_ah").value || 0;

    CT1.DF =
        +document.getElementById("df_ct").value || 0;

    LT1.DF =
        +document.getElementById("df_lt").value || 0;
    ...
    // Display
    document.getElementById("pg_mh").innerHTML =
        MH1.Pg.toFixed(2);

    document.getElementById("pg_ah").innerHTML =
        AH1.Pg.toFixed(2);

    document.getElementById("pg_ct").innerHTML =
        CT1.Pg.toFixed(2);

    document.getElementById("pg_lt").innerHTML =
        LT1.Pg.toFixed(2);
    ...
    // Hoist
    MH1.r =
        (2 * Math.PI * MH1.N * MH1.D) /
        (MH1.rk * MH1.V);

    AH1.r =
        (2 * Math.PI * AH1.N * AH1.D) /
        (AH1.rk * AH1.V);
    ...
    /* =================================================
       DISPLAY REQUIRED RATIO
    ================================================= */

    document.getElementById("r_mh").innerHTML =
        MH1.r.toFixed(2);

    document.getElementById("r_ah").innerHTML =
        AH1.r.toFixed(2);

    document.getElementById("r_ct").innerHTML =
        CT1.r.toFixed(2);

    document.getElementById("r_lt").innerHTML =
        LT1.r.toFixed(2);
    ...
    let mh_manu_ratio =
        +document.getElementById("r_mh_manu").value || 0;

    let ah_manu_ratio =
        +document.getElementById("r_ah_manu").value || 0;

    let ct_manu_ratio =
        +document.getElementById("r_ct_manu").value || 0;

    let lt_manu_ratio =
        +document.getElementById("r_lt_manu").value || 0;


    // Store manufacturer values
    MH1.manufacturerRatio = mh_manu_ratio;
    AH1.manufacturerRatio = ah_manu_ratio;
    CT1.manufacturerRatio = ct_manu_ratio;
    LT1.manufacturerRatio = lt_manu_ratio;
...
MH1.operationType = document.getElementById("mh-op").value;
AH1.operationType = document.getElementById("ah-op").value;
CT1.operationType = document.getElementById("ct-op").value;
LT1.operationType = document.getElementById("lt-op").value;
...
MH1.operationType = mhOp;
AH1.operationType = ahOp;
CT1.operationType = ctOp;
LT1.operationType = ltOp;
//============= DRUM SELECTION =================
...
MH1.drumDiaElectrical = mhDrum;
AH1.drumDiaElectrical = ahDrum;
CT1.drumDiaElectrical = ctDrum;
LT1.drumDiaElectrical = ltDrum;

MH1.drumTorqueElectrical = mhDrumT;
AH1.drumTorqueElectrical = ahDrumT;
CT1.drumTorqueElectrical = ctDrumT;
LT1.drumTorqueElectrical = ltDrumT;

MH1.drumDiaMechanical = mhDrumm;
AH1.drumDiaMechanical = ahDrumm;
CT1.drumDiaMechanical = ctDrumm;
LT1.drumDiaMechanical = ltDrumm;

MH1.drumTorqueMechanical = mhDrumTm;
AH1.drumTorqueMechanical = ahDrumTm;
CT1.drumTorqueMechanical = ctDrumTm;
LT1.drumTorqueMechanical = ltDrumTm;
//============= OUTPUT =================
...
MH1.brakeCount = mhBrakes;
AH1.brakeCount = ahBrakes;
CT1.brakeCount = ctBrakes;
LT1.brakeCount = ltBrakes;
...
function updateRecommendedSheave() {
	...
	// =====================================================
// STORE RECOMMENDED SHEAVE DATA FOR REPORT
// =====================================================

CRANE.SHEAVE.MH.mainRecommendation =
    mhMainSheave;

CRANE.SHEAVE.MH.eqRecommendation =
    mhEqSheave;

CRANE.SHEAVE.AH.mainRecommendation =
    ahMainSheave;

CRANE.SHEAVE.AH.eqRecommendation =
    ahEqSheave;
...
function restoreRopeRecommendationUI(prefix) {
    ...
    if (typeSelect && rope.powerformType) {
...
MH.manufacturerDia = mh_manu_dia;
AH.manufacturerDia = ah_manu_dia;

MH.standard = getRopeStandard("MH");
AH.standard = getRopeStandard("AH");

MH.powerformType =
    document.getElementById("mh_powerform_type")?.value || null;

AH.powerformType =
    document.getElementById("ah_powerform_type")?.value || null;

MH.powerformGrade =
    document.getElementById("mh_powerform_grade")?.value || null;

AH.powerformGrade =
    document.getElementById("ah_powerform_grade")?.value || null;


// ================= RECOMMENDED ROPE =================

let mhRecommendedTable = null;
let ahRecommendedTable = null;
...
if (MH.standard === "IS") {
    ...
    mhRecommendedTable =
        RopeTable[MH.core]?.[MH.grade];

} else {

    mhRecommendedTable =
        PowerformTable[MH.powerformType]
        ?.[MH.powerformGrade];
...
if (AH.standard === "IS") {
    ...
    ahRecommendedTable =
        RopeTable[AH.core]?.[AH.grade];

} else {

    ahRecommendedTable =
        PowerformTable[AH.powerformType]
        ?.[AH.powerformGrade];
...
MH.manufacturerMBF =
    MH.manufacturerDia &&
    mhRecommendedTable &&
    mhRecommendedTable[MH.manufacturerDia]
        ? Number(mhRecommendedTable[MH.manufacturerDia])
        : null;
...
AH.manufacturerMBF =
    AH.manufacturerDia &&
    ahRecommendedTable &&
    ahRecommendedTable[AH.manufacturerDia]
        ? Number(ahRecommendedTable[AH.manufacturerDia])
        : null;


// ================= STATUS =================

MH.manufacturerStatus =
    MH.manufacturerMBF != null
        ? MH.manufacturerMBF >= MH.BL
        : null;

AH.manufacturerStatus =
    AH.manufacturerMBF != null
        ? AH.manufacturerMBF >= AH.BL
        : null;
}
...
function calcSheave() {
    ...
    MH.Crc =
        +document.getElementById("Crc_MH").value || 0;


    // =====================================================
    // AUXILIARY HOIST INPUTS
    // =====================================================

    AH.d =
        +CRANE.ROPE.AH.finalDia;
    ...
    AH.Crc =
        +document.getElementById("Crc_AH").value || 0;
    ...
    document.getElementById("mh_Dm").innerHTML =
        MH.D.toFixed(0);

    document.getElementById("ah_Dm").innerHTML =
        AH.D.toFixed(0);


    document.getElementById("mh_Dmm").innerHTML =
        MH.DM.toFixed(0);

    document.getElementById("ah_Dmm").innerHTML =
        AH.DM.toFixed(0);


    document.getElementById("mh_De").innerHTML =
        MH.De.toFixed(0);

    document.getElementById("ah_De").innerHTML =
        AH.De.toFixed(0);


    document.getElementById("mh_Dee").innerHTML =
        MH.DE.toFixed(0);

    document.getElementById("ah_Dee").innerHTML =
        AH.DE.toFixed(0);
...
function updateFinalSheavePCD() {
    ...
    // =====================================================
    // MANUFACTURER / SELECTED MAIN SHEAVE PCD
    // =====================================================

    const mhManuMain =
        Number(document.getElementById("mh_Dpp").value) || 0;

    const ahManuMain =
        Number(document.getElementById("ah_Dpp").value) || 0;


    // =====================================================
    // MANUFACTURER / SELECTED EQUALIZER SHEAVE PCD
    // =====================================================

    const mhManuEq =
        Number(document.getElementById("mh_epp").value) || 0;

    const ahManuEq =
        Number(document.getElementById("ah_epp").value) || 0;
    ...
    const mhRecommendedMain =
        Number(
            document.getElementById("mh_main_sheave_pcd").innerText
        ) || 0;

    const ahRecommendedMain =
        Number(
            document.getElementById("ah_main_sheave_pcd").innerText
        ) || 0;


    // =====================================================
    // RECOMMENDED EQUALIZER SHEAVE
    // =====================================================

    const mhRecommendedEq =
        Number(
            document.getElementById("mh_eq_sheave_pcd").innerText
        ) || 0;

    const ahRecommendedEq =
        Number(
            document.getElementById("ah_eq_sheave_pcd").innerText
        ) || 0;
    ...
    CRANE.SHEAVE.MH.finalMainPCD =
        mhFinalMain || null;

    CRANE.SHEAVE.AH.finalMainPCD =
        ahFinalMain || null;

    CRANE.SHEAVE.MH.finalEqPCD =
        mhFinalEq || null;

    CRANE.SHEAVE.AH.finalEqPCD =
        ahFinalEq || null;
...
function calcDrumLen(){
	...
	// Store manufacturer values
    MH.manufacturerLength = mh_manu_L;
    AH.manufacturerLength = ah_manu_L;
    // Final Length
...
// =====================================================
// SAVE AUTO MOTOR DATA FOR REPORT
// =====================================================
...
CTE.motor = cte_auto_kw;
CTE.rpm = cte_auto_rpm;

LTE.motor = lte_auto_kw;
LTE.rpm = lte_auto_rpm;
...
function openReport() {
    ...
    calcCTLoad();
    calcLTLoad();
    // Wheel Selection after CT/LT loads
    calcWheelSelection();
	calcGearbox();
	calcBarrelCoupling();
	calcRopeDrumStress();
...
function sendReportData() {
    ...
    const data = {
        ...
        TRAVEL: {
            CT: {...CRANE.TRAVEL.CT},
            LT: {...CRANE.TRAVEL.LT},
            CTE: {...CRANE.TRAVEL.CTE},
            LTE: {...CRANE.TRAVEL.LTE}
        },
		...
		DRUM_DIA: {
             MH: {...CRANE.DRUM_DIA.MH},
             AH: {...CRANE.DRUM_DIA.AH}
        },
		DRUM_LEN: {
             MH: {...CRANE.DRUM_LEN.MH},
             AH: {...CRANE.DRUM_LEN.AH}
        },
		WHEEL_SELECTION: {
             CT: {...CRANE.WHEEL_SELECTION.CT},
             LT: {...CRANE.WHEEL_SELECTION.LT}
        },
		GEARBOX: {
             MH: {...CRANE.GEARBOX.MH},
             AH: {...CRANE.GEARBOX.AH},
		...
		BARREL_COUPLING: {
             MH1: {...CRANE.BARREL_COUPLING.MH1},
             AH1: {...CRANE.BARREL_COUPLING.AH1}
        },
		ROPE_DRUM_STRESS: {
             MH: {...CRANE.ROPE_DRUM_STRESS.MH},
             AH: {...CRANE.ROPE_DRUM_STRESS.AH},

             mechanismClass:
                 CRANE.ROPE_DRUM_STRESS.mechanismClass,

             e250Stress:
                 CRANE.ROPE_DRUM_STRESS.e250Stress,

             e350Stress:
                 CRANE.ROPE_DRUM_STRESS.e350Stress,
