...
MH.Ws  = +CRANE.BARREL_COUPLING.MH.Md; AH.Ws  = +CRANE.BARREL_COUPLING.AH.Md;
...
MH.scs = MH.scrs + MH.sbs;
AH.scs = AH.scrs + AH.sbs;

// ===== TORSION =====
MH.Ts = MH.Ps * (MH.PCDs/2);
AH.Ts = AH.Ps * (AH.PCDs/2);
...
function selectBarrelCoupling(requiredTorque, requiredRadial) {
  ...
  function calcBarrelCoupling() {
    ...
    let MH1 = CRANE.BARREL_COUPLING.MH; 
	let AH1 = CRANE.BARREL_COUPLING.AH;
