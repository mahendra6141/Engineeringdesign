function openTab(evt, tabName) {
    ...
    if (tabName === "Basic") {
        ...
        // Show assistant only on Basic Input tab
        assistantBtn.style.display = "flex";

    } else {

        // Hide assistant everywhere else
...
if(selectedMotor){
    ...
    pms.innerHTML = `
        <span style="color:green;font-weight:bold;">
            ✅ Selected Standard Motor : ${selectedMotor} kW
        </span>
    `;
...
function calcShaft(){
  ...
  let T2 = +document.getElementById("T2min").value;
