...
function  basicCalculation(){
  ...
  document.getElementById("bw").value = B.toFixed(0);
...
function calcPower(){
  ...
  let Pm = sf * Pa / eta1 / nt;
    ...
    // Agar Pm sabse bade rating se bhi bada ho
         if (!selectedMotor) {
    selectedMotor = motorRatings[motorRatings.length - 1];
                               }

  // Output
  document.getElementById("Pms").innerHTML = "✅ " + selectedMotor + " kW";
...
function checkGearRatio(){
    ...
    let selectedRatio = +document.getElementById("selectedRatio").value;

    let minRatio = ratio * 0.95;
    let maxRatio = ratio * 1.10;

    // Show allowable range
    ...
    if(selectedRatio >= minRatio && selectedRatio <= maxRatio){
        ...
        ratioStatus.innerHTML = "⚠ Gear Ratio Too Low";
        ...
        ratioStatus.innerHTML = "⚠ Gear Ratio Too High";
...
function calcShaft(){
  ...
  document.getElementById("R_b").value = R.toFixed(2);
   ...
   document.getElementById("ts_s").value = tsd.toFixed(3);
   document.getElementById("Kb_s").value = Kb.toFixed(1);
   document.getElementById("a_s").value = a.toFixed(1);
   document.getElementById("a_tp").value = a.toFixed(1);
   document.getElementById("a_sd").value = a.toFixed(1);
	...
	document.getElementById("ts_tp").value = tsd.toFixed(3);
	document.getElementById("Kb_tu").value = Kb.toFixed(1);
	document.getElementById("Kb_tp").value = Kb.toFixed(1);
