...
function openTab(evt, tabName)
{
    ...
    // Highlight selected button (only if button clicked)
    if(evt){
...
function fillReport()
{
    ...
    copyResult("xComp","rexComp");
    copyResult("y1Result","KComp");
    copyResult("thetaResult","thetar");
	copyResult("xext","reyComp");
    ...
    copyResult("Dc","rDc");
    copyResult("Dm","rDm");
    copyResult("tpResult","rtp");
    copyResult("CpResult","rCp");
    copyResult("CfResult","rCf");
    copyResult("CdResult","rCd");
    ...
    copyResult("KwrResult","rKwr");
    copyResult("KyResult","rKy");
    copyResult("KthetaResult","rKtheta");
